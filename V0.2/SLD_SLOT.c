...
uint8_t Get_SLOT_TYPE_from_file(char* file_name, uint8_t verb) {
	...
	if(verb) printf("%s", V_SLOT_TYPE_CONFIG);
		...
		switch(i) {
			...
			case 0x01:
				switch(Slot1_Cfg.Type)	{
					//Host Port
					case 0x00:
						printf("%s%s", V_SLOT1, V_SLOT_TYPE_HOST);
					break;

					//SLOT DOWNSTREAM PORT (EP)
					case 0x01:
						printf("%s%s", V_SLOT1, V_SLOT_TYPE_DWN);
					break;
			...
			case 0x02:
				switch(Slot2_Cfg.Type)	{
					//Host Port
					case 0x00:
						printf("%s%s", V_SLOT2, V_SLOT_TYPE_HOST);
					break;

					//SLOT DOWNSTREAM PORT (EP)
					case 0x01:
						printf("%s%s", V_SLOT2, V_SLOT_TYPE_DWN);
					break;
			...
			case 0x03:
				switch(Slot3_Cfg.Type)	{
					//Host Port
					case 0x00:
						printf("%s%s", V_SLOT3, V_SLOT_TYPE_HOST);
					break;

					//SLOT DOWNSTREAM PORT (EP)
					case 0x01:
						printf("%s%s", V_SLOT3, V_SLOT_TYPE_DWN);
					break;
			...
			case 0x04:
				switch(Slot4_Cfg.Type)	{
					//Host Port
					case 0x00:
						printf("%s%s", V_SLOT4, V_SLOT_TYPE_HOST);
					break;

					//SLOT DOWNSTREAM PORT (EP)
					case 0x01:
						printf("%s%s", V_SLOT4, V_SLOT_TYPE_DWN);
					break;
			...
			case 0x05:
				switch(Slot5_Cfg.Type)	{
					//Host Port
					case 0x00:
						printf("%s%s", V_SLOT5, V_SLOT_TYPE_HOST);
					break;

					//SLOT DOWNSTREAM PORT (EP)
					case 0x01:
						printf("%s%s", V_SLOT5, V_SLOT_TYPE_DWN);
					break;
			...
			case 0x06:
				switch(Slot6_Cfg.Type)	{
					//Host Port
					case 0x00:
						printf("%s%s", V_SLOT6, V_SLOT_TYPE_HOST);
					break;

					//SLOT DOWNSTREAM PORT (EP)
					case 0x01:
						printf("%s%s", V_SLOT6, V_SLOT_TYPE_DWN);
					break;
			...
			case 0x07:
				switch(Slot7_Cfg.Type)	{
					//Host Port
					case 0x00:
						printf("%s%s", V_SLOT7, V_SLOT_TYPE_HOST);
					break;

					//SLOT DOWNSTREAM PORT (EP)
					case 0x01:
						printf("%s%s", V_SLOT7, V_SLOT_TYPE_DWN);
					break;
			...
			case 0x01:
				...
				*/
				switch(Slot1_Cfg.Type)	{
					...
					case 0x00:
						if(verb) printf("%s%s", V_SLOT1, V_SLOT_TYPE_HOST);
					...
					case 0x01:
						if(verb) printf("%s%s", V_SLOT1, V_SLOT_TYPE_DWN);
			...
			case 0x02:
				...
				*/
				switch(Slot2_Cfg.Type)	{
					...
					case 0x00:
						if(verb) printf("%s%s", V_SLOT2, V_SLOT_TYPE_HOST);
					...
					//PCIe refclock disabled
					case 0x01:
						if(verb) printf("%s%s", V_SLOT2, V_SLOT_TYPE_DWN);
			...
			case 0x03:
				...
				*/
				switch(Slot3_Cfg.Type)	{
					...
					//PCIe refclock disabled
					case 0x00:
						if(verb) printf("%s%s", V_SLOT3, V_SLOT_TYPE_HOST);
					...
					//PCIe refclock disabled
					case 0x01:
						if(verb) printf("%s%s", V_SLOT3, V_SLOT_TYPE_DWN);
			...
			case 0x04:
				...
				*/
				switch(Slot4_Cfg.Type)	{
					...
					//PCIe refclock disabled
					case 0x00:
						if(verb) printf("%s%s", V_SLOT4, V_SLOT_TYPE_HOST);
					...
					//PCIe refclock disabled
					case 0x01:
						if(verb) printf("%s%s", V_SLOT4, V_SLOT_TYPE_DWN);
			...
			case 0x05:
				...
				*/
				switch(Slot5_Cfg.Type)	{
					...
					//PCIe refclock disabled
					case 0x00:
						if(verb) printf("%s%s", V_SLOT5, V_SLOT_TYPE_HOST);
			...
			case 0x06:
				...
				*/
				switch(Slot6_Cfg.Type)	{
					...
					//PCIe refclock disabled
					case 0x00:
						if(verb) printf("%s%s", V_SLOT6, V_SLOT_TYPE_HOST);
					...
					//PCIe refclock disabled
					case 0x01:
						if(verb) printf("%s%s", V_SLOT6, V_SLOT_TYPE_DWN);
			...
			case 0x07:
				...
				*/
				switch(Slot7_Cfg.Type)	{
					...
					//PCIe refclock disabled
					case 0x00:
						if(verb) printf("%s%s", V_SLOT7, V_SLOT_TYPE_HOST);
					...
					//PCIe refclock disabled
					case 0x01:
						if(verb) printf("%s%s", V_SLOT7, V_SLOT_TYPE_DWN);
...
void Check_CARD_PRSNT_STATUS() {
	...
	//SLOT1
	printf("%s", V_SLOT1);
	if( (SLOT_PRSNT >> SLT_PRSNT__SLOT1_PRSNT_BIT) & 1) printf("%s", V_CARD_PRESENCE);
	else printf("%s", V_CARD_NOPRESENCE);


	//SLOT2
	printf("%s", V_SLOT2);
	if( (SLOT_PRSNT >> SLT_PRSNT__SLOT2_PRSNT_BIT) & 1) printf("%s", V_CARD_PRESENCE);
	else printf("%s", V_CARD_NOPRESENCE);


	//SLOT3
	printf("%s", V_SLOT3);
	if( (SLOT_PRSNT >> SLT_PRSNT__SLOT3_PRSNT_BIT) & 1) printf("%s", V_CARD_PRESENCE);
	else printf("%s", V_CARD_NOPRESENCE);


	//SLOT4
	printf("%s", V_SLOT4);
	if( (SLOT_PRSNT >> SLT_PRSNT__SLOT4_PRSNT_BIT) & 1) printf("%s", V_CARD_PRESENCE);
	else printf("%s", V_CARD_NOPRESENCE);


	//SLOT5
	printf("%s", V_SLOT5);
	if( (SLOT_PRSNT >> SLT_PRSNT__SLOT5_PRSNT_BIT) & 1) printf("%s", V_CARD_PRESENCE);
	else printf("%s", V_CARD_NOPRESENCE);


	//SLOT6
	printf("%s", V_SLOT6);
	if( (SLOT_PRSNT >> SLT_PRSNT__SLOT6_PRSNT_BIT) & 1) printf("%s", V_CARD_PRESENCE);
	else printf("%s", V_CARD_NOPRESENCE);


	//SLOT7
	printf("%s", V_SLOT7);
	if( (SLOT_PRSNT >> SLT_PRSNT__SLOT7_PRSNT_BIT) & 1) printf("%s", V_CARD_PRESENCE);
	else printf("%s", V_CARD_NOPRESENCE);
