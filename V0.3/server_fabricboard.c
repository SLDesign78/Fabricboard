...
//Power Control
uint8_t volatile SYS_PWR_EN=0x00, SYS_PWR_OK=0x00;
...
//SYSTEM
char CMD_USER[BUFF_L_SIZE];
volatile int EXIT= 0x00;;
...
const char* p3v3_on_CMD 	 		= "p3v3_on"; 
const char* p3v3_off_CMD 	 		= "p3v3_off"; 
const char* p1v8_on_CMD 	 		= "p1v8_on"; 
const char* p1v8_off_CMD 	 		= "p1v8_off"; 
const char* p0v9_on_CMD 	 		= "p0v9_on"; 
const char* p0v9_off_CMD 	 		= "p0v9_off"; 


const char* pon_CMD 	 			= "power_on"; 
const char* poff_CMD 	 			= "power_off";
const char* pstatus_CMD 	 		= "power_status";
const char* sys_status_CMD 	 		= "sys_status";
const char* get_slot_cfg_CMD 		= "get_slot_cfg";			
const char* set_slot_cfg_CMD 		= "set_slot_cfg";

const char* get_fan1_CMD 			= "get_fan1";
const char* get_fan2_CMD 			= "get_fan2";
const char* set_fan1_CMD 			= "set_fan1";
const char* set_fan2_CMD 			= "set_fan2";
const char* get_power_CMD 			= "get_power";
const char* get_pex_CMD 			= "get_pex";
const char* get_temp_rh_CMD 		= "get_temp_rh";


const char* MUX4_CH0_CMD 			= "mux4_ch0";
const char* MUX4_CH1_CMD 			= "mux4_ch1";
const char* MUX4_CH2_CMD 			= "mux4_ch2";
const char* MUX4_ALL_CMD 			= "mux4_all";

const char* gpio_ext_all_off_CMD 	= "gpio_ext_off";

const char* test_CMD 				= "test";
const char* get_fw_vers_CMD 		= "get_fw_vers";
...
//POWER CONTROL
const char* V_PWR_ON = "=> P O W E R  O N\n\r";
const char* V_PWR_OFF = "=> P O W E R  O F F\n\r";
const char* V_PWR_OK = "=> P O W E R  O K\n\r";
const char* V_PWR_EPO = "=> E M E R G E N C Y  P O W E R  O F F\n\r";
...
// 	****  THREAD1 - Socket UNIX: SERVER  ****
//----------------------------------------
// S O C K E T    U N I X    S E R V E R
//----------------------------------------
...
void * SKT_SERVER_THR()
{
    ...
    bind(server_fd, (struct sockaddr *) &server_addr, slen);
    ...
    while(!EXIT) {
		...
		char *message = (char*) calloc(BUFF_L_SIZE + 1, sizeof(char));
		recv(client_fd, message, BUFF_L_SIZE, 0);
...
int main ()
{
	...
	GPIO_WR(SEL_SPI_MUX, CHIP1, LOW);				//SEL MUX_SPI: FLASH > SPI_PEX
	GPIO_I2CEXP_WR(EXP1, SEL_SW_UART_CM4, HIGH);	//SEL UART ARM PEX: UART > UART_CM4
	...
	char *_str_verbose = (char*) calloc(BUFF_M_SIZE, sizeof(char));
	
	Get_SLOT_TYPE_from_file(File_slot_type, _str_verbose);	//Get Slot Type from config file
	Init_SLOT_CFG(_str_verbose);							//Init slot configuration
	printf("%s", _str_verbose);								//verbose
	free(_str_verbose);
	...
	//Socket Unix: Server
	pthread_create(&thr1, NULL, &SKT_SERVER_THR, NULL); 
